...
func configureShakeGesture() {
	...
	typealias ImpBlock = @convention(block) (UIWindow?, UIEvent.UIEvent.EventSubtype, UIEvent?) -> Void
	typealias Imp = @convention(c) (UIWindow?, Selector, UIEvent.UIEvent.EventSubtype, UIEvent?) -> Void
